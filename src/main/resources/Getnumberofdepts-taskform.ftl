<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("numberOfDepts");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid numberOfDepts");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: deptApprovals.Getnumberofdepts
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">numberOfDepts</label>
                            		<div class="div_texbox">
                              		<input name="numberOfDepts" type="text" class="textbox" id="numberOfDepts" value="${numberOfDepts}" />
                            		</div>
